...
INTPTR is_abbreviation(CFSWString s, CFSArray<CFSWString> &a) {
    ...
    if (s == L"aj") return explode(L"aa jott", sp, a);
    if (s == L"ak") return explode(L"aa kaa", sp, a);
    ...
    if (s == L"dl") return explode(L"dee ell", sp, a);
    ...
    if (s == L"EL") return explode(L"ee ell", sp, a);
...
//    if (s == L"M") return explode(L"meestele", sp, a);
    ...
    if (s == L"nn") return explode(L"nii nimetatud", sp, a);
    ...
    if (s == L"ps") return explode(L"pee ess", sp, a);
    ...
    if (s == L"sl") return explode(L"ess ell", sp, a);
    ...
    if (s == L"tk") return explode(L"tükki", sp, a);
    if (s == L"tl") return explode(L"tee ell", sp, a);
